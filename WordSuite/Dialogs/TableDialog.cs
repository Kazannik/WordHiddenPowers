...
namespace WordSuite.Dialogs
{
    public partial class TableDialog : Form
    {
        ...
        public TableDialog(RepositoryDataSet powersDataSet, Table table)
        {
            SumTable = table;
            ...
            WordHiddenPowers.Repositoryes.RepositoryDataSet dataSet = new WordHiddenPowers.Repositoryes.RepositoryDataSet();
        ...
        private void SetXml(WordHiddenPowers.Repositoryes.RepositoryDataSet dataSet, string xml)
        {
