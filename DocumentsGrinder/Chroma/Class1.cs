...
namespace DocumentsGrinder.Chroma
{
	internal class Class1
	{
		public async void test()
		{
			...
			//await string5Client.Add(new List<string>(new string[] { "340a36ad-c38a-406c-be38-250174aee5a4" }), embeddings: new List<ReadOnlyMemory<float>>( new ReadOnlyMemory<float> ( new float[] { 1f, 0.5f, 0f, -0.5f, -1f }));
