...
namespace WordHiddenPowers
{
	partial class AddInMainRibbon : Microsoft.Office.Tools.Ribbon.RibbonBase
	{
			...
			: base(Globals.Factory.GetRibbonFactory())
		{
			...
			GlobalsEventsBus.InitializeComponent += new System.EventHandler(GlobalsEventsBus_InitializeComponent);

			GlobalsEventsBus.DocumentPropertiesChanged += new System.EventHandler<DocumentEventArgs>(GlobalsEventsBus_DocumentPropertiesChanged);
			GlobalsEventsBus.DocumentChatMessageModeChanged += new System.EventHandler<DocumentChatMessageModeEventArgs>(GlobalsEventsBus_DocumentChatMessageModeChanged);

			GlobalsEventsBus.NewDocument += new System.EventHandler<WordDocumentEventArgs>(GlobalsEventsBus_NewDocument);
			GlobalsEventsBus.DocumentOpen += new System.EventHandler<WordDocumentEventArgs>(GlobalsEventsBus_DocumentOpen);
			...
			llmButton1.Enabled = false;
			llmButton2.Enabled = false;
		...
		private void InitializeComponent()
		{
			...
			this.contentGroup = this.Factory.CreateRibbonGroup();
			...
			// wordHiddenPowersTab
			// 
			this.wordHiddenPowersTab.Groups.Add(this.contentGroup);
			...
			this.wordHiddenPowersTab.Groups.Add(this.aboutGroup);
			...
			// contentGroup
			// 
			this.contentGroup.Items.Add(this.newDataButton);
			this.contentGroup.Items.Add(this.openDataButton);
			this.contentGroup.Items.Add(this.saveDataButton);
			this.contentGroup.Items.Add(this.separator1);
			this.contentGroup.Items.Add(this.deleteDataButton);
			this.contentGroup.Items.Add(this.separator2);
			this.contentGroup.Items.Add(this.editCategoriesButton);
			this.contentGroup.Items.Add(this.createTableButton);
			this.contentGroup.Items.Add(this.editDocumentKeysButton);
			this.contentGroup.Label = "Макет данных";
			this.contentGroup.Name = "contentGroup";
			this.contentGroup.DialogLauncherClick += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.ContentGroup_DialogLauncherClick);
			// 
			// newDataButton
			// 
			...
			// llmGroup
			// 
			this.llmGroup.DialogLauncher = ribbonDialogLauncherImpl1;
			...
			this.llmGroup.DialogLauncherClick += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.LLMGroup_DialogLauncherClick);
			// 
			// llmButton1
			// 
			this.llmButton1.ControlSize = Microsoft.Office.Core.RibbonControlSize.RibbonControlSizeLarge;
			this.llmButton1.Image = global::WordHiddenPowers.Properties.Resources.LLMFormat;
			...
			this.llmButton2.Image = global::WordHiddenPowers.Properties.Resources.LLMFormat;
			...
			this.llmReplaceButton.Image = global::WordHiddenPowers.Properties.Resources.ai_process;
			...
			this.llmReplaceButton.Visible = false;
			...
			this.chatDialogButton.Image = global::WordHiddenPowers.Properties.Resources.LLM_Dialog_48;
			this.chatDialogButton.Label = "Эмбеддинг";
			...
			this.chatDialogButton.Visible = false;
			...
			this.aboutButton.Image = global::WordHiddenPowers.Properties.Resources.ai_process;
			this.aboutButton.Label = "О программе ...";
			this.aboutButton.Name = "aboutButton";
			this.aboutButton.ScreenTip = "О программе";
			this.aboutButton.ShowImage = true;
			this.aboutButton.SuperTip = "Подробные сведения об надствойке, коде продукта и авторских правах";
		...
		internal Microsoft.Office.Tools.Ribbon.RibbonGroup contentGroup;
