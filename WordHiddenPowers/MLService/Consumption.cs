...
namespace WordHiddenPowers.MLService
{
	public partial class MLModel
	{
		...
		{
			var predEngine = PredictEngine(mlNetModelPath).Value;
			var result = predEngine.Predict(input);
			return GetSortedScoresWithLabels(result, mlNetModelPath);
		}
		...
		public static IOrderedEnumerable<KeyValuePair<string, float>> GetSortedScoresWithLabels(ModelOutput result, string mlNetModelPath)
		{
			var unlabeledScores = result.Score;
			var labelNames = GetLabels(result, mlNetModelPath);
		...
		/// <exception cref="Exception"></exception>
		private static IEnumerable<string> GetLabels(ModelOutput result, string mlNetModelPath)
		{
			var schema = PredictEngine(mlNetModelPath).Value.OutputSchema;
