...
namespace WordHiddenPowers.Repositoryes.WordFiles
{
    public class WordFile : IComparable<WordFile>
    {
        ...
        public int CompareTo(Object value)
        {
            ...
            if (value is WordFile)
            {
                WordFile c = (WordFile)value;
